...
module RPC_API(R : RPC) = struct
  ...
  let push_sr_rrd =
    ...
    declare "push_sr_rrd"
      ...
      ; "RRD already in memory for the SR. Data sources will be recorded to this"
      ; "RRD subsequently." ]
  ...
  let add_sr_ds = declare "add_sr_ds"
    [ "Adds am SR data source to the SR RRD. This causes the data source to be"
    ; "recorded if it wasn't a default data source." ]
