...
(* OASIS_START *)
(* DO NOT EDIT (digest: c730db102d644dad2e440f3cc9348c0d) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test.native", []))];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xapi-backtrace", None)
                        ];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["V6_interface"; "V6_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xcp";
                      lib_findlib_name = Some "v6";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "example.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\005\172\145\218)\248\218\224\029\018q7\167\182\214W";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
