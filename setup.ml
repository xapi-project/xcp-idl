...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5676db1fb59abf6a037555fc161ebc94) *)
(*
...
let setup_t =
  {
       ...
       [
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("./xenops_interface_upgrades_test.native", []))
                   ];
          ...
          ("channel_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./channel_test.native", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Storage_client";
                           "Storage_skeleton";
                           "Storage_skeleton_test"
                        ];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xcp";
                      lib_findlib_name = Some "storage";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "storage_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "storage_test.ml"});
               Library
                 ({
                     cs_name = "xcp_network";
                     cs_data = PropList.Data.create ();
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Data_source"; "Ds"; "Rrd_interface"; "Rrd_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xcp";
                      lib_findlib_name = Some "rrd";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xcp";
                      lib_findlib_name = Some "xen";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "xenops_upgrade_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_interface_upgrade.ml"
                   });
               Test
                 ({
                     cs_name = "xenops_upgrade_test";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Memory_interface"; "Memory_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xcp";
                      lib_findlib_name = Some "memory";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "channel_helper.ml"});
               Executable
                 ({
                     cs_name = "channel_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "channel_test.ml"});
               Test
                 ({
                     cs_name = "channel_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "d\233\250h\019\146\194_\227#B\177\231+\146O";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
